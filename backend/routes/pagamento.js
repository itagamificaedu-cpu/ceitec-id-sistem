...
const PLANOS = [
  {
    ...
    recursos: [
      ...
      'ItagGame na sua turma',
      'Repositório Digital',
      'Dashboard da turma',
      'Acesso celular, tablet e PC',
    ],
    destaque: false,
    contato: false,
  },
  {
    ...
    periodo: 'mês',
    periodo_dias: 30,
    descricao: 'Para escolas até ~300 alunos',
    subtitulo: '≈ R$ 1,00 por aluno/mês',
    recursos: [
      'Múltiplos professores',
      'ItagGame + Ranking da escola',
  ...
  {
    id: 'prefeitura',
    nome: 'Plano Prefeitura',
    preco: null,
    periodo: 'aluno/mês',
    periodo_dias: 30,
    descricao: 'Redes e secretarias municipais',
    subtitulo: 'R$ 1,00/aluno/mês — mín. R$ 2.500/mês',
    recursos: [
      'Toda a rede escolar',
      'Multi-escola e multi-usuário',
      'Dashboard consolidado por rede',
      'Modelo transparente para licitação',
      'Treinamento presencial incluso',
      'Gerente de conta dedicado',
      'Logo da prefeitura na plataforma',
    ],
    destaque: false,
    contato: true, // não passa pelo Mercado Pago — vai para WhatsApp
  },
];
