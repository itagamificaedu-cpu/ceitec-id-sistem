...
async function initDatabase() {
  ...
  const tabelas = [
    ...
    `CREATE TABLE IF NOT EXISTS itagame_online (id SERIAL PRIMARY KEY, aluno_id INTEGER UNIQUE NOT NULL, escola_id INTEGER, ultimo_ping BIGINT DEFAULT 0)`,
    ...
    /* Controla qual atividade está ativa por turma — aluno só vê quando status='em_andamento' */
    ...
    /* Participantes registrados em cada partida (time escolhido) */
    ...
    /* Respostas dos alunos por pergunta */
